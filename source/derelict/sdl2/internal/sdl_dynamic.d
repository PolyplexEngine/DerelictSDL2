...
*/
module derelict.sdl2.internal.sdl_dynamic;
...
extern(C) @nogc nothrow {
    ...
    alias da_SDL_DequeueAudio = Uint32 function(SDL_AudioDeviceID,void*,Uint32);
    ...
    alias da_SDL_GetHintBoolean = SDL_bool function(const(char)*,SDL_bool);
    ...
    alias da_SDL_JoystickGetDeviceInstanceID = SDL_JoystickType function(int);
    ...
    alias da_SDL_CreateRenderer = SDL_Renderer* function(SDL_Window*,int,SDL_RendererFlags);
    ...
    alias da_SDL_CreateTexture = SDL_Texture* function(SDL_Renderer*,Uint32,SDL_TextureAccess,int,int);
    ...
    alias da_SDL_RenderGetIntegerScale = SDL_bool function(SDL_Renderer*);
    ...
    alias da_SDL_CreateRGBSurfaceWithFormat = SDL_Surface* function(Uint32,int,int,int,Uint32);
    alias da_SDL_CreateRGBSurfaceFrom = SDL_Surface* function(void*,int,int,int,int,Uint32,Uint32,Uint32,Uint32);
    alias da_SDL_CreateRGBSurfaceWithFormatFrom = SDL_Surface* function(void*,int,int,int,int,Uint32);
    ...
    alias da_SDL_CreateWindow = SDL_Window* function(const(char)*,int,int,int,int,SDL_WindowFlags);
    ...
    alias da_SDL_GetWindowFlags = SDL_WindowFlags function(SDL_Window*);
    ...
    alias da_SDL_GetWindowBordersSize = int function(SDL_Window*,int*,int*,int*,int*);
    ...
    alias da_SDL_SetWindowResizable = void function(SDL_Window*,SDL_bool);
    ...
    alias da_SDL_SetWindowOpacity = int function(SDL_Window*,float);
    alias da_SDL_GetWindowOpacity = int function(SDL_Window*,float*);
    alias da_SDL_SetWindowModalFor = int function(SDL_Window*,SDL_Window*);
    alias da_SDL_SetWindowInputFocus = int function(SDL_Window*);
...
__gshared {
    ...
    da_SDL_DequeueAudio SDL_DequeueAudio;
...
//    da_SDL_AudioDeviceConnected SDL_AudioDeviceConnected;
    ...
    da_SDL_GetHintBoolean SDL_GetHintBoolean;
    ...
    da_SDL_RenderSetIntegerScale SDL_RenderSetIntegerScale;
    da_SDL_RenderGetIntegerScale SDL_RenderGetIntegerScale;
    ...
    da_SDL_CreateRGBSurfaceWithFormat SDL_CreateRGBSurfaceWithFormat;
    da_SDL_CreateRGBSurfaceFrom SDL_CreateRGBSurfaceFrom;
    da_SDL_CreateRGBSurfaceWithFormatFrom SDL_CreateRGBSurfaceWithFormatFrom;
    ...
    da_SDL_GetWindowBordersSize SDL_GetWindowBordersSize;
    ...
    da_SDL_SetWindowResizable SDL_SetWindowResizable;
    ...
    da_SDL_SetWindowOpacity SDL_SetWindowOpacity;
    da_SDL_GetWindowOpacity SDL_GetWindowOpacity;
    da_SDL_SetWindowModalFor SDL_SetWindowModalFor;
    da_SDL_SetWindowInputFocus SDL_SetWindowInputFocus;
